...
local function setKeystate()
    vthumb.buttonA.justPressed = (love.keyboard.isDown("w") or love.keyboard.isDown("z")) and vthumb.buttonA.pressed == false
    ...
    vthumb.buttonA.pressed = love.keyboard.isDown("w") or love.keyboard.isDown("z")
